            ...
            auto func = [this] (){
                        ...
                        while ( this->activated )
                        {
                            ...
                            if (r == -1 && errno == EAGAIN) // really need errno?
                                ...
                                7. button/lid LID open
                                8. button/lid LID close
                                ...
                                */
                                ...
                                std::string lidopen("button/lid LID open");
                                std::string lidclose("button/lid LID close");
                                ...
                                if(buffstring.compare(0, headplug.length(), headplug) == 0){
                                        //audiojack_connect()
                                ...
                                else if(buffstring.compare(0, lidopen.length(), lidopen) == 0){
                                        auto it = listeners.begin();
                                        auto endP = listeners.end();
                                        for (; it!=endP; ++it){
                                            it->lid_open();
                                ...
                                else if(buffstring.compare(0, lid.length(), lidclose) == 0){
                                        auto it = listeners.begin();
                                        auto endP = listeners.end();
                                        for (; it!=endP; ++it){
                                            it->lid_close();
